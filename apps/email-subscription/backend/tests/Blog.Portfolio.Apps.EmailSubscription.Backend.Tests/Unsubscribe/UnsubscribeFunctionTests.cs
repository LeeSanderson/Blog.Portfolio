...
using Blog.Portfolio.Apps.EmailSubscription.Backend.Unsubscribe;
using FluentAssertions;
using Moq;

namespace Blog.Portfolio.Apps.EmailSubscription.Backend.Tests.Unsubscribe;

public class UnsubscribeFunctionTests
{
    ...
    [Fact]
    public async Task HandleAsync_WithAConfirmSignaturePresentedToUnsubscribe_IsRejected()
    {
